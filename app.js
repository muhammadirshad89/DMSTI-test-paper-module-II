...
var quiz = {
    ...
    "options": [
    {
    "a": "The operating system and other programs such as Microsoft Word and Microsoft PowerPoint",
    "b": "The physical parts of the computer including the monitor, the keyboard, and the mouse.",
    "c": "Neither",
    "d": "Both A & B"
    
    }
    ],
    "answer": "The physical parts of the computer including the monitor, the keyboard, and the mouse.",
    "score": 0,
    "status": ""
    },
    {
    "id": 2,
    "question": "Which of these are software?",
    "options": [
    {
    "a": "Trackball",
    "b": "Scanner",
